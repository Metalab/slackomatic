...
public class HelloArtnetRack {

	public static void main(String[] args) throws Exception {
		new HelloArtnetRack().go(args);
	}
	...
	public void go(String[] args) throws Exception {
		...
		color1 = ArrayUtils.add(color1, (byte) 1); // one-shot mode (aka streaming)
		...
		color2 = ArrayUtils.add(color2, (byte) 1); // one-shot mode (aka streaming)
		for(int i = 0; i < leds; i++) {
